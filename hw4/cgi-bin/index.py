...
# adapted from both https://github.com/tdlm/fun-with-python/blob/master/states_and_capitals.py
# and Jonathan Meade's data he pulled from https://www.maxmind.com/en/home
states_coords = [
    {"state": "AL", "coords": "32.2334,-86.2085"},
    {"state": "AK", "coords": "58.3019,-134.4197"},
    {"state": "AZ", "coords": "33.2765,-112.1872"},
    {"state": "AR", "coords": "34.7465,-92.2896"},
    {"state": "CA", "coords": "38.5816,-121.4944"},
    {"state": "CO", "coords": "39.7474,-104.9928"},
    {"state": "CT", "coords": "41.7637,-72.6851"},
    {"state": "DE", "coords": "39.1582,-75.5244"},
    {"state": "FL", "coords": "30.4383,-84.2807"},
    {"state": "GA", "coords": "33.749,-84.388"},
    {"state": "HI", "coords": "24.8598,-168.0218"},
    {"state": "ID", "coords": "43.4599,-116.244"},
    {"state": "IL", "coords": "39.7495,-89.606"},
    {"state": "IN", "coords": "39.7684,-86.158"},
    {"state": "IA", "coords": "41.6727,-93.5722"},
    {"state": "KS", "coords": "39.0429,-95.7697"},
    {"state": "KY", "coords": "38.2341,-84.8748"},
    {"state": "LA", "coords": "30.5159,-91.0804"},
    {"state": "ME", "coords": "44.3106,-69.7795"},
    {"state": "MD", "coords": "38.9785,-76.4922"},
    {"state": "MA", "coords": "42.3389,-70.9196"},
    {"state": "MI", "coords": "42.5992,-84.372"},
    {"state": "MN", "coords": "45.0059,-93.1059"},
    {"state": "MS", "coords": "32.2988,-90.1848"},
    {"state": "MO", "coords": "38.5309,-92.2493"},
    {"state": "MT", "coords": "46.5927,-112.0361"},
    {"state": "NE", "coords": "40.908,-96.7103"},
    {"state": "NV", "coords": "39.1638,-119.7674"},
    # {"state": "NH", "coords": "43.2081,-71.5376"},
    # {"state": "NJ", "coords": "40.2171,-74.7429"},
    # {"state": "NM", "coords": "35.687,-105.9378"},
    # {"state": "NY", "coords": "42.6149,-73.9708"},
    # {"state": "NC", "coords": "35.7721,-78.6386"},
    # {"state": "ND", "coords": "46.8083,-100.7837"},
    # {"state": "OH", "coords": "39.969,-83.0114"},
    # {"state": "OK", "coords": "35.5514,-97.4075"},
    # {"state": "OR", "coords": "44.9849,-122.9988"},
    # {"state": "PA", "coords": "40.2737,-76.8844"},
    # {"state": "RI", "coords": "41.824,-71.4128"},
    # {"state": "SC", "coords": "34.006,-80.9708"},
    # {"state": "SD", "coords": "44.5422,-100.2754"},
    # {"state": "TN", "coords": "36.1659,-86.7844"},
    # {"state": "TX", "coords": "30.3264,-97.7713"},
    # {"state": "UT", "coords": "40.7685,-111.8879"},
    # {"state": "VT", "coords": "44.2601,-72.5754"},
    # {"state": "VA", "coords": "37.5538,-77.4603"},
    # {"state": "WA", "coords": "47.0379,-122.9007"},
    # {"state": "WV", "coords": "38.3498,-81.6326"},
    # {"state": "WI", "coords": "43.0696,-89.4239"},
    # {"state": "WY", "coords": "41.3274,-104.6664"}
]
...
for key in states_coords:
        coords = key["coords"]
        jsonData = urllib2.urlopen(
                'https://api.forecast.io/forecast/c35f32834426b304f9b849df3e824d16/{}'.format(coords))
